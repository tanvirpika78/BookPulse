...
class data extends db {
    ...
    function recommendbook($bookname, $author, $genre, $description, $userid) {
        $this->bookname = $bookname;
        $this->author = $author;
        $this->genre = $genre;
        ...
        $q = "INSERT INTO recommendations (bookname, author, genre, description, userid) 
              VALUES ('$bookname', '$author', '$genre', '$description', '$userid')";

        if ($this->connection->exec($q)) {
            header("Location:otheruser_dashboard.php?userlogid=$userid&msg=Recommendation Submitted");
        } else {
            header("Location:otheruser_dashboard.php?userlogid=$userid&msg=Recommendation Failed");
        }
    }
//

    //display recmnd books
